...
$.fn.parallaxTiming = function () {
  ...
  var timing = new _scrollParallax_Timing__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"](opt.el || this[0], opt.eventScrollPosition, opt.eventTriggerPercentage || $.eventTriggerPercentage, timingEvent || [function () {
...
$.fn.parallaxSpeed = function (opt) {
  var $el = this;
  var s = new _scrollParallax_Speed__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]($el[0], opt.style || opt.styles, opt.speed || 2, opt.min || -99999, opt.max || 99999, opt.contentScrollPosition || 0, opt.contentScrollPositionStyleValue, opt.eventTriggerPercentage || $.eventTriggerPercentage);
  setScrollEvents(function (status) {
...
$.fn.parallaxFit = function (opt, eventTriggerPercentage) {
  var $el = this;
  var fit = new _scrollParallax_Fit__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]($el[0], opt.eventTriggerPercentage || eventTriggerPercentage || $.eventTriggerPercentage);
