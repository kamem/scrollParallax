...
var setScrollEvents = function setScrollEvents(func, opt) {
  ...
  status.functions.push([func, opt.targetPercentage || opt.eventTriggerPercentage && new _scrollParallax_ScrollStatus__WEBPACK_IMPORTED_MODULE_0__[/* ScrollPosition */ "a"](_objectSpread({}, status, {
  ...
  install: function install(Vue, opt) {
      ...
      updateFunction: function updateFunction(status) {
        ...
        $scrollStatus.values = Object.assign({}, $scrollStatus.values, status.functions.reduce(function (result, _ref) {
          ...
          return Object.assign({}, result, current(scrollPosition ? Object.assign({}, status, {
            scrollPosition: scrollPosition.generateScrollPosition(status.stageSize)
          }) : status));
        }, {}));
      }
    }));
    ...
    Vue.directive('parallax-timing', {
      bind: function bind(el, _ref3, _ref4) {
        ...
        var opt = value || o;
        var timing = new _scrollParallax_Timing__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"](opt.el || el, opt.eventScrollPosition, opt.toggle || [function () {
